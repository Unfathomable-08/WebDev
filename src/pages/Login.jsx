  ...
  return (
    <div className="flex items-center justify-center h-screen">
      ...
      <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="absolute w-58 h-58 md:w-60 md:h-60 lg:w-100 lg:h-100 left-4 -top-12 filter blur-xs">
        <path fill="#282464" d="M27.4,-10.8C39.5,5.1,56,23.5,52.2,38.3C48.3,53.1,24.2,64.3,2.5,62.8C-19.2,61.4,-38.4,47.3,-51.4,27.3C-64.3,7.2,-71.1,-18.9,-61.5,-33.3C-51.9,-47.7,-25.9,-50.6,-9.1,-45.3C7.7,-40,15.4,-26.7,27.4,-10.8Z" transform="translate(100 100)" />
      </svg>
      ...
      <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="absolute w-58 h-58 md:w-60 md:h-60 lg:w-100 lg:h-100 right-0 lg:right-36 bottom-0 filter blur-xs">
        <path fill="#282464" d="M38,-57.9C48.6,-52.3,56.3,-40.7,54.7,-29.3C53.1,-17.9,42.4,-6.7,34.9,0.9C27.5,8.6,23.4,12.6,19.9,18C16.4,23.5,13.7,30.3,7.6,37.2C1.6,44.1,-7.7,51.1,-18.5,52.6C-29.2,54.2,-41.4,50.3,-53.6,42.8C-65.8,35.3,-78,24.1,-77.1,12.7C-76.2,1.3,-62.2,-10.3,-54,-23.1C-45.7,-35.9,-43.3,-49.7,-35.3,-56.5C-27.3,-63.3,-13.6,-63.1,0,-63.1C13.7,-63.2,27.3,-63.5,38,-57.9Z" transform="translate(100 100)" />
      </svg>
      ...
      <div className={`relative bg-white shadow-[0_0_15px_#000000aa] rounded-2xl p-8 w-full lg:max-w-2xl md:max-w-xl sm:max-w-md max-w-sm flex overflow-hidden transform ${showSignup ? "rotate-y-180" : ""}`}>
        ...
        <div className={`relative z-10 w-full md:w-1/2 py-6 text-center transform ${showSignup ? "rotate-y-180" : ""}`}>
          <h1 className="text-2xl font-bold text-gray-800 drop-shadow-3xl" style={{ textShadow: "0 0 15px white" }}>
            {showSignup ? "Create Account" : "Hello!"}
          </h1>
          <p className="text-black mb-6 drop-shadow-3xl" style={{ textShadow: "0 0 15px white" }}>
        ...
        {/* Right Section: Info */}
        <div className={`max-md:hidden relative transform -translate-y-4 z-10 w-1/2 flex flex-col justify-center items-center p-6 rounded-2xl transform ${showSignup ? "rotate-y-180" : ""}`}>
          <h2 className="text-xl font-bold">{showSignup ? "Welcome!" : "Welcome Back!"}</h2>
          <p className="text-center text-sm mt-2">
            {showSignup 
              ? "Join us and start your learning journey today!"
              : "Already a member? Sign in to continue your courses!"
            }
          </p>
        </div>
